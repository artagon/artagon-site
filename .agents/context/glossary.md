...
- New tooling/docs: `AGENTS.md`, `openspec/AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `playwright.config.ts`, `src/components/Difference.astro`, plus committed LHCI reports under `.lighthouseci/`.
