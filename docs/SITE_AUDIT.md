...
> page count grew from 15 to 23 routes, and the `Next Steps` items
> below have largely shipped (Lighthouse CI lives at
> `lighthouserc.json` per `openspec/specs/check-site-quality`;
