...
1. Visit [Favicon Checker](https://realfavicongenerator.net/favicon_checker)
2. Enter site URL
3. Verify all platforms show correct icons

### Manifest Validator
1. Visit [Web Manifest Validator](https://manifest-validator.appspot.com/)
2. Paste content of `site.webmanifest`
3. Ensure no errors or warnings

### Maskable Icon Preview
1. Visit [Maskable.app](https://maskable.app/editor)
2. Upload `/icons/icon-maskable-512.png`
3. Verify icon isn't clipped in any safe zone
...
- [PWA Icons Guide](https://web.dev/add-manifest/#icons) - Google's icon requirements
- [Apple Touch Icon](https://developer.apple.com/library/archive/documentation/AppleApplications/Reference/SafariWebContent/ConfiguringWebApplications/ConfiguringWebApplications.html) - iOS specifications
- [Maskable Icons](https://web.dev/maskable-icon/) - Adaptive icon design
- [Favicon Best Practices](https://github.com/audreyfeldroy/favicon-cheat-sheet) - Comprehensive guide
- [Web Manifest Spec](https://w3c.github.io/manifest/) - W3C standard
