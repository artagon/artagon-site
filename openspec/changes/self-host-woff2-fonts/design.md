...
Subset each WOFF2 to U+0020-007F (Basic Latin), U+00A0-024F (Latin-1 Supplement + Latin Extended-A/B), U+2010-2027 + U+2030-205E (general punctuation), U+2070-209F (super/sub), U+20A0-20BF (currency), U+2122 (TM), U+25CF (•), U+FB00-FB04 (ligatures `fi`, `fl`).
