...
- [ ] 1.1 Add `.github/workflows/copilot-setup-steps.yml` with a single `copilot-setup-steps` job that checks out the repo, installs the latest LTS Node.js version, and runs `npm ci`.
